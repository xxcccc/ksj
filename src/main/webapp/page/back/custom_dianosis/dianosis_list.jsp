...
<body>
	...
	<div class="rightinfo">
		...
		<div class="tools">
			...
			<ul class="toolbar">
				<li>
					<a href="${pageContext.request.contextPath }/page/user/custom_insert.jsp"> <span>
			...
			<ul class="toolbar1">
				<li>
					...
					<span>
						<input type="text" name="" value="" style="height:23px;" />
					</span>
					<span>
						<button style="height: 23px;width: 40px;">搜索</button>
					</span>
				</li>
			</ul>
		...
		<table class="tablelist">
			...
			<tbody>
				<tr>
					...
					<td>2013-09-09 15:05</td>
					<td>
						<a href="${pageContext.request.contextPath }/page/user/dianosisType_insert.jsp"
							class="tablelink">录入数据</a> &nbsp;&nbsp; <a href="#" class="tablelink">查看详情</a> &nbsp;&nbsp; <a
							href="#" class="tablelink">修改</a> &nbsp;&nbsp;
					</td>
				</tr>
				...
				<tr>
					...
					<td>2013-09-09 15:05</td>
					<td>
						<a href="#" class="tablelink">录入数据</a> &nbsp;&nbsp; <a href="#" class="tablelink">查看</a>
