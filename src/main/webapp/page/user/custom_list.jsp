  ...
  <body>
	...
	<div class="rightinfo">
		...
		<div class="tools">
			...
			<ul class="toolbar">
				<li>
					<a href="${pageContext.request.contextPath }/user/forward.action">
		...
		<table class="tablelist">
			...
			<tbody>
				<c:forEach items="${customList }" var="custom">
					<tr>
						<td><input id="" class="raido" type="checkbox" name="" value="${custom.customid }"/></td>
						<td><span>${custom.customid }</span></td>
						<td><span>${custom.name }</span></td>
						<td>
						...
						<td><span>${custom.phone }</span></td>
						<td><span>1980-01-01</span></td>
						<td><span>${custom.wechat }</span></td>
