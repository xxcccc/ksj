package com.codet.fonts.custom.controller;
...
@Controller
@RequestMapping("/fonts/custom")
public class CustomFrontController {

	@Autowired
	private CustomFrontService customService;
	...
	public String customLogin(Custom custom,Model model) throws Exception{
		...
		if(customService.login(custom)){
			Custom custom2 = customService.findCustomByName(custom.getCustomname());
